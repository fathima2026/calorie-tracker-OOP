class CalorieTracker{
    ...
    addWorkout(workout){
        ...
        this._dispayNewWorkout(workout)
        this._render();
    ...
    loadItems(){
        this._meals.forEach(meal=>this._dispayNewMeal(meal));
        this._workouts.forEach(workout=>this._dispayNewWorkout(workout));
    }
    // private methods 
